...
public class Teste implements Serializable {
  ...
  * @generated
  */
  @Column(name = "sumario", nullable = true, unique = false, insertable=true, updatable=true)
   ...
   * @generated
   */
  public Teste setDescricao(java.lang.String descricao){
  ...
  /**
   * Define sumario
   * @param sumario sumario
   * @generated
   */
  public Teste setSumario(java.lang.String sumario){
